...
const Banner = () => {
    return (
        <div className="lg:bg-[#f99f1c]  flex gap-y-24  flex-col lg:flex-row justify-center items-center lg:rounded-3xl">
            ...
            <div className="lg:w-1/2 bg-[#fd9460] h-[190px] flex justify-center items-end  w-full  lg:h-auto lg:bg-transparent rounded-3xl lg:rounded-none">
